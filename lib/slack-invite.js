...
export default function invite ({ org, token, email, channel }, fn){
  ...
  if (data.email.indexOf('ibm.com') < 0){
	  fn(new Error(`I'm really sorry, but at this moment this is a private team. Only IBMers can join. If you are an IBMer please use your *.ibm.com email.`))
	  return
	  console.log('test')
  }
